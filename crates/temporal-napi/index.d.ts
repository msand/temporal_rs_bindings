...
export declare const enum Disambiguation {
...
export declare const enum DisplayCalendar {
  Auto = 'Auto',
  Always = 'Always',
  Never = 'Never',
  Critical = 'Critical'
...
export declare const enum DisplayOffset {
  Auto = 'Auto',
  Never = 'Never'
}

export declare const enum DisplayTimeZone {
  Auto = 'Auto',
  Never = 'Never',
  Critical = 'Critical'
}
...
export declare const enum OffsetDisambiguation {
  Use = 'Use',
  Prefer = 'Prefer',
  Ignore = 'Ignore',
  Reject = 'Reject'
