...
class PlainMonthDay {
  ...
  static from(arg, options) {
    ...
    if (typeof arg === 'object' && arg !== null) {
      ...
      // Per spec: for non-ISO calendars, monthCode is required for PlainMonthDay
      if (mdFromCalId && mdFromCalId !== 'iso8601' && !hasMonthCode) {
        throw new TypeError(`monthCode is required for PlainMonthDay with calendar '${mdFromCalId}'`);
      }
