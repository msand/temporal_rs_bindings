...
function toNapiCalendar(cal) {
  ...
  if (typeof cal === 'string') return call(() => new NapiCalendar(cal));
  if (cal && typeof cal === 'object' && cal.id) return call(() => new NapiCalendar(cal.id));
...
function toNapiTimeZone(tz) {
  ...
  if (tz && typeof tz === 'object' && tz.id) return call(() => new NapiTimeZone(tz.id));
